...
class SyfosyketilfelleMock {
    ...
    private fun mockServer(): NettyApplicationEngine {
        return embeddedServer(
            ...
            routing {
                get("${SyfosyketilfelleClient.SYFOSYKETILFELLE_OPPFOLGINGSTILFELLE_PERSON_PATH}/${ARBEIDSTAKER_AKTORID.value}") {
                    call.respond(oppfolgingstilfellePersonResponse)
                }
                get("${SyfosyketilfelleClient.SYFOSYKETILFELLE_OPPFOLGINGSTILFELLE_PERSON_PATH}/${ARBEIDSTAKER_NO_OPPFOLGINGSTILFELLE_AKTORID.value}") {
                    call.respond(HttpStatusCode.NoContent)
                }
                get("${SyfosyketilfelleClient.SYFOSYKETILFELLE_OPPFOLGINGSTILFELLE_PERSON_PATH}/${ARBEIDSTAKER_OPPFOLGINGSTILFELLE_ERROR.value}") {
